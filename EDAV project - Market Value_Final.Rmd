---
title: "EDAV project - Property Market Values"
author: "Andres"
date: "April 20, 2018"
...
## Analysis of Property Market Value
...
```{r}
property_upper_east <- read.csv("property_upper_east.csv")
#head(property_upper_east)
...
due to the extensive work needed to read and pre-process the data (one data file per year), the additional work performed is presented in separate RMD/Html files. 
